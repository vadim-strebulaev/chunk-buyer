...
- В чужом привате нельзя открывать контейнеры и использовать наковальни; разрешены ender chest, верстак, стол зачарований и безопасные интерактивные блоки без прочности/хранилища.
